            ...
            function mask(el) {
                ...
                function keydownEvent(e) {
                    ...
                    if (k == opts.keyCode.BACKSPACE || k == opts.keyCode.DELETE || (iphone && k == 127)) {//backspace/delete
                        var maskL = getMaskLength();
                        if ((pos.begin > 4 && Math.abs(pos.begin - pos.end) == 0 && k == opts.keyCode.BACKSPACE) ||
                            (pos.end > 3 && Math.abs(pos.begin - pos.end) == 0 && k == opts.keyCode.DELETE) ||
                            (pos.begin > 2 && Math.abs(pos.begin - pos.end) > 0 && pos.end > 2)
                        ) {
