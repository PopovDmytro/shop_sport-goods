$(document).ready(function () {
    ...
    $("#search_inp").autocomplete("/autocomplete/", {
        ...
        formatItem: function (data, i, n, value) {
            ...
            if (image == 'lastitems') {
                return '<a class="all_items" href="javascript: void();">' + name + '<i class="fa fa-angle-right" aria-hidden="true"></i></a>';
            }

            price = value.split('=')[3];
            fullprice = value.split('=')[4];

            var fullPriceEl = fullprice ? '<div class="a_fullprice">' + fullprice + '</div>' : '';

            return '<a href="javascript: void();" ><div ><img src="' + image + '" /></div><div class="a_descr" >' + name + '</div><div class="price_field" >' + fullPriceEl + '<div class="real_price">' + price + '</div><div class="a_valu">грн</div></div></a>';

        },
        formatResult: function (data, i, n, a) {
            return i.split('=')[2];
        }
    ...
    $('.button_bell').click(function () {
        var contact = $('.bells_form-wrapper');
    ...
    $('.bells_form .bell_button').click(function () {
        ...
        if (bels.name.length < 3) {
            ...
            $('input[name="bell[name]"]').css('border-color', '');
        ...
        if (bels.phone.length < 2) {
            ...
            $('input[name="bell[phone]"]').css('border-color', '');
    ...
    $('.quick_order_form .quick_order_button').click(function () {
        ...
        if (quick_orders.phone.length < 12) {
            ...
            $('input[name="quick_order[phone]"]').css('border-color', '');
    ...
    $('.contact_form .contact_button').on('click', function () {
        ...
        if (contact.name.length < 3) {
            ...
            $('input[name="contact[name]"]').css('border-color', '');
        ...
        if (!regExpression.test(contact.email)) {
            ...
            $('input[name="contact[email]"]').css('border-color', '');
        ...
        if (contact.text.length < 2) {
            ...
            $('textarea[name="contact[text]"]').css('border-color', '');
        ...
        if (data == 'ok') {
            ...
            $('.feedbackPopupWrapper').removeClass('hide').find('input, textarea').val('');
        } else {
            $('.captcha-form-error').css('opacity', '1');
            $('input[name="contact[code]"]').css('border-color', '');
        }
    });
