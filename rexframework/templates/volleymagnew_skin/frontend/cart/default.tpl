                        ...
                        <div id="cart-main-table" class="checkout_table-row">
                            <div class="checkout_thead-row">
                                <div class="row collapse">
                                    ...
                                    <div class="checkout_th columns small-3 xlarge-2 xlarge-offset-05"><h3>Название</h3></div>
                                    <div class="checkout_th columns small-3 xlarge-3 xlarge-offset-05"><h3>Параметры</h3></div>
                                    {*{if $issetUncheckedSku}<div class="checkout_th columns small-1 xlarge-offset-1"><h3>Размер</h3></div>{/if}*}
                                    <div class="checkout_th columns small-2 large-3 xlarge-2"><h3>Количество</h3></div>
                                    <div class="checkout_th columns small-2 large-1 xlarge-offset-05"><h3>Цена</h3></div>
                                    <div class="checkout_th columns small-1 xlarge-offset-05"><h3>Удалить</h3></div>
                                </div>
                            </div>
                                ...
                                {if $cart.product}
                                     <div class="checkout_tbody-row">
                                         <div class="row collapse">
                                             ...
                                             <div class="checkout_td columns small-3 xlarge-2 xlarge-offset-05">
                                                 <a class="product-name" href="{url mod=product act=default cat_alias=$pcatalog_alias task=$productEntity->id}">
                                                     {$productEntity->name}
                                                 </a>
                                             </div>
                                             <div class="checkout_td columns small-3 xlarge-3 xlarge-offset-05">
                                                 <div class="">
                                                     <div>
                                             ...
                                             <div class="checkout_td columns small-2 large-3 xlarge-2">
                                             ...
                                             <div class="checkout_td columns small-2 large-1 xlarge-offset-05 align-center">
                                             ...
                                             <div class="checkout_td columns small-1 xlarge-offset-05 align-center">
                                ...
                                <div class="row collapse">
                                    <div class="columns">
                                        <dl class="amount-dl full-price">
                                            ...
                                            <dd>{if $sale > 0}<span class="cart-alltogether_old"><span class="price"></span>&nbsp;грн</span>&nbsp;&nbsp;&nbsp;{/if}<span class="cart-alltogether"></span>&nbsp;<span>грн</span>&nbsp;&nbsp;{if $sale > 0}(со скидкой {$sale}%){/if}</dd>
                                        </dl>
                                        <dl ></dl>
                                    </div>
                                </div>
...
$(document).ready(function(){
        ...
        $('.count-minus').die('click').live('click', function(){
            ...
            $('.cart-alltogether_old').text(floorN(alltogether));
        });
