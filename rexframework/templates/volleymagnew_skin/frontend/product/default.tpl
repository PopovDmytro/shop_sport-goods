...
<div class="product-page">
    ...
    <section class="product-card_main-section">
                        ...
                        <li>
                            <div class="product-card_logo-holder">
                                <a class="name-cat" href="{url mod=pCatalog task=$pcatalog->alias brand_alias=$productBrand->alias}">
                                    {assign var=img_path value="skin/volleymagnew_skin/frontend/img/main-page/`$productBrand->alias`_logo.png"}
                                    {if file_exists($img_path)}
                                        {img src="main-page/{$productBrand->alias}_logo.png" alt=$productBrand->name}
                                    {else}
                                        {$productBrand->name}
                                    {/if}
                                </a>
        ...
        <div class="row info-block">
            <div class="columns xlarge-9 large-12 small-12 medium-12">
