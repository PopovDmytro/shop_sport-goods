<div class="breadcrumbs-block row">
    <div class="columns small-12">
        <ul class="breadcrumbs_list no-bullet">
            ...
            <li class="breadcrumbs_item active">
                <a href="javascript:void(0)" class="breadcrumbs_link">Редактирование настроек:&nbsp;{$userentity.email}</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    <form action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row small-up-1 py-1 table-reg">
                            <div class="input-holder column">
                                {*Фамилия:*}
                                <input placeholder="Фамилия" type="text" class="profile-edit-input titlex" name="profile[lastname]" maxlength="128" value="{$userentity.lastname}">
                            </div>
                            <div class="input-holder column">
                                {*Имя:*}
                                <input placeholder="Имя" type="text" class="profile-edit-input titlex" name="profile[name]" maxlength="128" value="{$userentity.name}">
                            </div>
                            <div class="input-holder column">
                                {*Адрес:*}
                                <input placeholder="Адрес" type="text" class="profile-edit-input titlex" name="profile[address]" maxlength="128" value="{$userentity.address}">
                            </div>
                            <div class="input-holder column">
                                {*E-Mail:*}
                                <input placeholder="E-Mail" type="text" class="profile-edit-input titlex" name="profile[email]" maxlength="128" value="{$userentity.email}">
                            </div>
                            <div class="input-holder column">
