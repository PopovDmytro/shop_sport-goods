    ...
    */
    function &parseDatasrc($datasrc, &$obj)
    {
        ...
        if (!is_readable($datasrc)) {
            return PEAR::staticRaiseError("Datasource file cannot be read.", null, PEAR_ERROR_RETURN);
        }
        ...
        foreach ($lines as $line) {
            ...
            if (preg_match('/^\s*'.$this->options['comment'].'+\s*(.*?)\s*$/', $line, $match)) {
                ...
                return PEAR::staticRaiseError("Syntax error in '$datasrc' at line $n.", null, PEAR_ERROR_RETURN);
            }
        }
        return $return;
