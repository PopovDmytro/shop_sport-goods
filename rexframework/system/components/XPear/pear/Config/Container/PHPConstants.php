    ...
    */
    function &parseDatasrc($datasrc, &$obj)
    {
        ...
        if (!file_exists($datasrc)) {
            return PEAR::staticRaiseError("Datasource file does not exist.", null, 
                PEAR_ERROR_RETURN);
        }
        ...
        if (!$fileContent) {
            return PEAR::staticRaiseError("File '$datasrc' could not be read.", null,
                PEAR_ERROR_RETURN);
        }
    ...
    */
    function writeDatasrc($datasrc, &$obj)
    {
        ...
        if ($fp) {
            ...
            return PEAR::staticRaiseError('Cannot open datasource for writing.', 1, 
                PEAR_ERROR_RETURN);
        }
