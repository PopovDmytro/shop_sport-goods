...
require_once 'Excel/Writer/Format.php';
require_once 'Excel/Writer/BIFFwriter.php';
require_once 'Excel/Writer/Worksheet.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    * @return Spreadsheet_Excel_Writer_Worksheet reference to a worksheet object on success, PEAR_Error
    *               on failure
    */
    ...
    */
    ...
    {
        include_once 'Excel/Writer/Validator.php';
