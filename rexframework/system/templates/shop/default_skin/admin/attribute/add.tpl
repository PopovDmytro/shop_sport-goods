    ...
    <form method="post" enctype="multipart/form-data" action="" class="addform">
        ...
        <table cellspacing="5" cellpadding="0" border="0" width="100%">
            ...
            <tr>
                ...
                <td class="frame-t-td">
                    <input id="attr_name" type="text" name="entity[name]" maxlength="128" value="{if $entity->name}{$entity->name|escape:'html'}{/if}" style="width: 280px;">
                </td>
            </tr>
            <tr>
                <td class="frame-t-td-l">
                ...
                <td class="frame-t-td">
                    <input id="attr_alias" type="text" name="entity[alias]" maxlength="128" value="{if $entity->alias}{$entity->alias|escape:'html'}{/if}" style="width: 280px;">
                </td>
            </tr>
        </table>
        </div>
