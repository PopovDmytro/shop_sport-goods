    ...
    <form method="post" enctype="multipart/form-data" action="" class="addform">
        ...
        <table cellspacing="5" cellpadding="0" border="0" width="100%">
            <tr>
                ...
                <td class="frame-t-td">
                    <input id="news_name" name="entity[name]" type="text" maxlength="255" value="{if $entity->name}{$entity->name|escape}{/if}" style="width: 210px;" >
                </td>
            </tr>
            <tr>
                <td class="frame-t-td-l">
                ...
                <td class="frame-t-td">
                    <input id="news_alias" name="entity[alias]" type="text" maxlength="255" {if $act eq 'edit'}readonly="readonly" onselectstart="return false;" onfocus="this.blur();"{/if} value="{if $entity->alias}{$entity->alias|escape}{/if}" style="width: 210px;" >
                </td>
            </tr>
            <tr>
                <td class="frame-t-td-l">
...
{literal}
    ...
    template.find("#news_name").keyup(function(e){
        ...
        if ($('#button').find('span')[0].innerText != 'Update') {
