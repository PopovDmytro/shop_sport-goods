{assign var=iteration value=0}
    {foreach from=$new_productList key=featured_key item=featured name=product_list}
        {assign var=featured_id value=$featured.id}
        {if $new_brandList.$featured_id}
            {assign var=featuredBrand value=$new_brandList.$featured_id}
        {/if}
        {assign var=featuredCategory value=$new_categoryList.$featured_id}
        ...
        {/if}
                <div class="item-img">
                    {if $new_imageList.$featured_id}
                        {assign var=image value=$new_imageList.$featured_id}    
