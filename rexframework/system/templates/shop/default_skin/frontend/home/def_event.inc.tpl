    ...
    {foreach from=$event_productList key=featured_key item=featured name=product_list}
        {assign var=featured_id value=$featured.id}
        {if $event_brandList.$featured_id}
            {assign var=featuredBrand value=$event_brandList.$featured_id}
        {/if}
        {assign var=featuredCategory value=$event_categoryList.$featured_id}
        ...
        {/if}
                <div class="item-img">  
                    {if $event_imageList.$featured_id}
                        {assign var=image value=$event_imageList.$featured_id}    
                ...
                {else} 
                    ...
                    {/if}
                {/if}
                {*<a class="a-button bgcolor round" href="#"> Купить!</a>
                <a class="a-button bgcolor round" href="#"> Сравнить</a>*}
            </div>    
